...
public class NetUtil {
    ...
    public static boolean isNetConnected() {
        ...
        ConnectivityManager connectivityManager
                = (ConnectivityManager) AppUtil.context().getSystemService(Context.CONNECTIVITY_SERVICE);
...
//        networkInfo.isConnected();
     ...
     */
    public static boolean isPhoneNetConnected() {
        int typeMobile = ConnectivityManager.TYPE_MOBILE;//手机网络类型
        return isNetworkConnected(typeMobile);
    }
     ...
     */
    public static boolean isWifiNetConnected() {
     ...
     */
    private static boolean isNetworkConnected(int typeMobile) {
        boolean ret = false;
        //判断是否有网络
        if (!isNetConnected()) {
            //如果没有网络连接，直接返回
        ...
        //获取到网络连接管理器
        ConnectivityManager connectManger = (ConnectivityManager) AppUtil.context().getSystemService(Context.CONNECTIVITY_SERVICE);

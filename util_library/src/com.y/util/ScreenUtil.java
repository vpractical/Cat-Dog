...
public class ScreenUtil {
    ...
    public static int getStatusHeight() {
        ...
        try {
            ...
            statusHeight = AppUtil.context().getResources().getDimensionPixelSize(height);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return statusHeight;
    ...
    public static DisplayMetrics getDisplayMetrics() {
        WindowManager manager = (WindowManager) AppUtil.context().getSystemService(Context.WINDOW_SERVICE);
